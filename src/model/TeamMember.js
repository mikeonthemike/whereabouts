...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WhereIsApi.TeamMember = factory(root.WhereIsApi.ApiClient);
  }
   ...
   */
  var exports = function(id, name, baseLocation) {
    var _this = this;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('baseLocation')) {
        obj['baseLocation'] = ApiClient.convertToType(data['baseLocation'], 'String');
      }
    }
    return obj;
  }
  ...
  /**
   * @member {String} baseLocation
   */
  exports.prototype['baseLocation'] = undefined;
